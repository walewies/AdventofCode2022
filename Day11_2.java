...
class Day11_2 {
    ...
    public static void main(String[] args) {
        ...
        int num_of_round = 10000;

        int supermodulo = 1;
        for (int i = 0; i < monkeys.size(); i++) {
            supermodulo *= Integer.parseInt(monkeys.get(i).get(3));
        }
            ...
            for (int j = 0; j < monkeys.size(); j++) {
                ...
                if (!monkeys.get(j).get(1).equals("")) {
                    ...
                    for (int k = 0; k < current_monkey_items.size(); k++) {
                        ...
                        working_item = Long.valueOf(current_monkey_items.get(k));
                        ...
                        // Uses modulo because of integer overflow                      
                        working_item = working_item % supermodulo;
                        ...
                        if (working_item % Integer.parseInt(monkeys.get(j).get(3)) == 0) {                        
                            ...
                            if (true_monkey_items.equals("")) {
                                monkeys.get(index_of_true_monkey).set(1, true_monkey_items += String.valueOf(working_item));
                            } else {
                                monkeys.get(index_of_true_monkey).set(1, true_monkey_items += ", " + String.valueOf(working_item));
                            }
                            ...
                            if (false_monkey_items.equals("")) {
                                monkeys.get(index_of_false_monkey).set(1, false_monkey_items += String.valueOf(working_item));
                            } else {
                                monkeys.get(index_of_false_monkey).set(1, false_monkey_items += ", " + String.valueOf(working_item));
                            }
                        }
        ...
        Long max_1 = Long.valueOf(0);
        Long max_2 = Long.valueOf(0);
        for (int i = 0; i < monkey_inspections.size(); i++) {
            if (monkey_inspections.get(i) > max_2) {
                if (monkey_inspections.get(i) > max_1) {
                    max_2 = max_1;
                    max_1 = Long.valueOf(monkey_inspections.get(i));
                } else {
                    max_2 = Long.valueOf(monkey_inspections.get(i));
                }
            }
        }
